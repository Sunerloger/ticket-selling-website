...
public class ApplicationUserEndpointTest {
    ...
    */
    ...
    public void testResetPassword() throws Exception {
        ...
        String expectedEncodedPassword = passwordEncoder.encode(resetPasswordUser.newPassword());

        String body = objectMapper.writeValueAsString(resetPasswordUser);
        tokenRepository.save(passwordResetToken);
        MvcResult resetResult = this.mockMvc.perform(post(BASE_PATH + "/reset-password")
                .contentType(MediaType.APPLICATION_JSON)
